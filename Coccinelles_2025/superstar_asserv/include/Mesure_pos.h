...
private:
     ...
     */
    float K_angle = 1. / 16.8; // TODO : regler les facteurs si on change la meca
    float K_r = 1. / 88.87;      // TODO : regler les facteurs si on change la meca
    float K_l = 1. / 89.66;      // TODO : regler les facteurs si on change la meca
    /**
